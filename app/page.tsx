...
export default function HomePage() {
  return (
    <>
        ...
        <div className="container site-header__inner">
          ...
          <nav className="site-nav" aria-label="Main navigation">
            ...
            <div className="nav-item" data-dropdown="">
              <button className="nav-item__trigger" aria-expanded="false" aria-haspopup="true">
                Loans
                <svg className="nav-item__chevron" viewBox="0 0 24 24"><polyline points="6 9 12 15 18 9"/></svg>
              </button>
              <div className="nav-dropdown" role="menu">
                <a href="/us/mortgage-calculator/" className="nav-dropdown__link" role="menuitem">
                  <span className="nav-dropdown__icon"><svg viewBox="0 0 24 24"><path d="M3 9l9-7 9 7v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z"/><polyline points="9 22 9 12 15 12 15 22"/></svg></span>
                  <span className="nav-dropdown__text"><span className="nav-dropdown__label">Mortgage</span><span className="nav-dropdown__hint">PITI payment breakdown</span></span>
                </a>
                <a href="/us/car-loan-calculator/" className="nav-dropdown__link" role="menuitem">
                  <span className="nav-dropdown__icon"><svg viewBox="0 0 24 24"><circle cx="7" cy="17" r="2"/><circle cx="17" cy="17" r="2"/><path d="M5 17H3v-6l2-5h9l4 5h1a2 2 0 0 1 2 2v4h-2"/><path d="M9 17h6"/></svg></span>
                  <span className="nav-dropdown__text"><span className="nav-dropdown__label">Auto Loan</span><span className="nav-dropdown__hint">Monthly car payment estimate</span></span>
                </a>
                <a href="/us/personal-loan-calculator/" className="nav-dropdown__link" role="menuitem">
                  <span className="nav-dropdown__icon"><svg viewBox="0 0 24 24"><rect x="1" y="4" width="22" height="16" rx="2" ry="2"/><line x1="1" y1="10" x2="23" y2="10"/></svg></span>
                  <span className="nav-dropdown__text"><span className="nav-dropdown__label">Personal Loan</span><span className="nav-dropdown__hint">Unsecured loan calculator</span></span>
                </a>
              </div>
            </div>
            ...
            <div className="nav-item" data-dropdown="">
              ...
              <div className="nav-dropdown" role="menu">
                <a href="/us/compound-interest-calculator/" className="nav-dropdown__link" role="menuitem">
                  <span className="nav-dropdown__icon"><svg viewBox="0 0 24 24"><polyline points="23 6 13.5 15.5 8.5 10.5 1 18"/><polyline points="17 6 23 6 23 12"/></svg></span>
                  <span className="nav-dropdown__text"><span className="nav-dropdown__label">Compound Interest</span><span className="nav-dropdown__hint">Visualize investment growth</span></span>
                </a>
                <a href="/us/roi-calculator/" className="nav-dropdown__link" role="menuitem">
                  <span className="nav-dropdown__icon"><svg viewBox="0 0 24 24"><line x1="12" y1="1" x2="12" y2="23"/><path d="M17 5H9.5a3.5 3.5 0 0 0 0 7h5a3.5 3.5 0 0 1 0 7H6"/></svg></span>
                  <span className="nav-dropdown__text"><span className="nav-dropdown__label">ROI Calculator</span><span className="nav-dropdown__hint">Return on investment analysis</span></span>
                </a>
                <a href="/us/cap-rate-calculator/" className="nav-dropdown__link" role="menuitem">
                  <span className="nav-dropdown__icon"><svg viewBox="0 0 24 24"><path d="M3 3v18h18"/><path d="M18 17V9"/><path d="M13 17V5"/><path d="M8 17v-3"/></svg></span>
                  <span className="nav-dropdown__text"><span className="nav-dropdown__label">Cap Rate</span><span className="nav-dropdown__hint">Real estate capitalization rate</span></span>
                </a>
              </div>
            </div>
            ...
            <div className="nav-item" data-dropdown="">
              ...
              <div className="nav-dropdown" role="menu">
                <a href="/us/retirement-savings-calculator/" className="nav-dropdown__link" role="menuitem">
                  <span className="nav-dropdown__icon"><svg viewBox="0 0 24 24"><path d="M19 5c-1.5 0-2.8 1.4-3 2-3.5-1.5-11-.3-11 5 0 1.8 0 3 2 4.5V20h4v-2h3v2h4v-4c1-.5 1.7-1 2-2h2v-4h-2c0-1-.5-1.5-1-2"/><path d="M2 9.5a1 1 0 1 1 2 0"/></svg></span>
                  <span className="nav-dropdown__text"><span className="nav-dropdown__label">{"401(k) Calculator"}</span><span className="nav-dropdown__hint">Retirement nest egg projection</span></span>
                </a>
                <a href="/us/social-security-calculator/" className="nav-dropdown__link" role="menuitem">
                  <span className="nav-dropdown__icon"><svg viewBox="0 0 24 24"><path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"/></svg></span>
                  <span className="nav-dropdown__text"><span className="nav-dropdown__label">Social Security</span><span className="nav-dropdown__hint">Estimate your SS benefits</span></span>
                </a>
              </div>
            </div>

            {/* Tools Direct Link */}
            <a href="/#tools" className="nav-item__trigger">Tools</a>
          </nav>

          {/* Right Utility */}
          <div className="header-utility">
            <button className="header-search-btn" aria-label="Open search" data-search-toggle="">
          ...
          {/* Mobile Menu Toggle */}
          <button className="nav-mobile-toggle" aria-label="Open menu" aria-expanded="false" data-mobile-toggle="">
      ...
      {/* Search Overlay */}
      <div className="search-overlay" id="search-overlay" aria-hidden="true" role="dialog" aria-label="Search calculators">
        <div className="search-overlay__inner">
          <div className="search-overlay__bar">
            <svg viewBox="0 0 24 24"><circle cx="11" cy="11" r="8"/><line x1="21" y1="21" x2="16.65" y2="16.65"/></svg>
            <input className="search-overlay__input" type="search" placeholder="Search calculators..." aria-label="Search calculators" />
      ...
      <div className="mobile-nav-backdrop" id="mobile-nav-backdrop" aria-hidden="true" />
      <aside className="mobile-nav-panel" id="mobile-nav-panel" aria-label="Mobile navigation" aria-hidden="true">
        <div className="mobile-nav__header">
          ...
          <button className="mobile-nav__close" aria-label="Close menu" data-mobile-close="">
            <svg viewBox="0 0 24 24"><line x1="18" y1="6" x2="6" y2="18"/><line x1="6" y1="6" x2="18" y2="18"/></svg>
          </button>
        </div>
        <div className="mobile-nav__body">
          <p className="mobile-nav__section-title">Loans</p>
          ...
          <a href="/us/car-loan-calculator/" className="mobile-nav__link">
            <svg viewBox="0 0 24 24"><circle cx="7" cy="17" r="2"/><circle cx="17" cy="17" r="2"/><path d="M5 17H3v-6l2-5h9l4 5h1a2 2 0 0 1 2 2v4h-2"/><path d="M9 17h6"/></svg>
            Auto Loan
          </a>
          ...
          <p className="mobile-nav__section-title">Investments</p>
          ...
          <p className="mobile-nav__section-title">Retirement</p>
          <a href="/us/retirement-savings-calculator/" className="mobile-nav__link">
            <svg viewBox="0 0 24 24"><path d="M19 5c-1.5 0-2.8 1.4-3 2-3.5-1.5-11-.3-11 5 0 1.8 0 3 2 4.5V20h4v-2h3v2h4v-4c1-.5 1.7-1 2-2h2v-4h-2c0-1-.5-1.5-1-2"/><path d="M2 9.5a1 1 0 1 1 2 0"/></svg>
            {"401(k) Calculator"}
          </a>
          ...
          <p className="mobile-nav__section-title">Resources</p>
          <a href="/#tools" className="mobile-nav__link">
